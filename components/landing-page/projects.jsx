    ...
    return(
        <div className={"p-10 py-12 space-y-16"}>
            ...
            <Project
                ...
                year="B2024"
                description="Examining Kikuhama's traffic congestion, linking it to tourism, ecology, and urban development to improve quality of life."
            ...
            <Project
                ...
                year="B2022"
                description="Exploring the impact of the Takase River canal restoration in Kikuhama, revealing conflicts between residents and the municipality."
